    ...
    <div className="container-fluid justify-content-md-start bg-dark text-white p-3">
      ...
      >
        <div className="offcanvas-header m-3">
          {storedAuth.cargo == "Chofer" ? (
            <span className="h3 text-center">Chofer</span>
          ) : (
              ...
              {entriesToShow.map((entry, index) => (
                <li key={index} className="list-group-item mb-3">
                  ...
                  <NavLink
                    className={({ isActive }) =>
                      isActive
                        ? "text-decoration-none fs-6 py-3 rounded w-100 d-inline-block p-2 hover-effect d-flex align-items-center active"
                        : "text-decoration-none fs-6 py-3 rounded w-100 d-inline-block p-2 hover-effect d-flex align-items-center"
                    }
                    to={`/admin/${entry.link}`}
                  >
