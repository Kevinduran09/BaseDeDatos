...
import { MenuItem, FormControl, Select, Grid, Button, InputLabel, Input } from '@mui/material';
...
export const Solicitud = () => {;
    ...
    const handleDeleteSolicitud = async (idSolicitud) => {
        try {
            const flag = await show_option('Eliminar', '¿Desea eliminar la solicitud?', 'warning');
            console.log(flag);
            if (flag) {
    ...
    const columns = [
        ...
        { field: 'idCliente', headerName: 'Cliente', width: 150, renderCell: (params) => params.row.cliente.nombre },
        { field: 'idServicio', headerName: 'Servicio', width: 200, renderCell: (params) => params.row.servicio.tipoServicio },
        { field: 'idDestino', headerName: 'Destino', width: 259, renderCell: (params) => params.row.destino.descripcionValor },
        ...
        { field: 'estado', headerName: 'Estado', width: 150 },
        {
            field: 'acciones', headerName: 'Acciones', width: 150, renderCell: (params) => (
                <>
                    <Actions {...{ params }} editFuntion={selectedSolicitud} deleteFunction={handleDeleteSolicitud} />
                </>
            )
        }
    ];
